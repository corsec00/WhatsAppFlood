...
Suddenly, a portion of the wave disappears down a crystallike hole, emerging in a much darker region of the universe --
...
The drill that Case is operating GROANS as the thirty-yearold battery runs out of charge. Case casts it aside and
...
Cooper finds Brand taking samples from the tree-like lifeforms, which are wildly different from their counterparts
...
trapped in the ice above absorb xrays and emit light. In return,
...
then I could just reprogram you toShe stops. Something has caught her attention.
COOPER
What?
BRAND
...
85.
ROTH
Fascinating. I thinkCase grabs him by the arm and pushes him bodily into the
shelter after Doyle.
...
COOPER
Why nAs he speaks, the creature on his chest extends four spindly,
...
foliage to join him.
BRAND (CONT'D)
Cooper, honestly, you're a bit of aShe stops. Cooper is standing at a sheer cliff.
...
Case, what is that?
CASE
It's nighttime. The native lifeforms are mobile again.
...
we don'tThe comms equipment TONES as it translates a packet. Then
another.
1
...
we left behindDoyle cuts her off, filled with anger.
DOYLE
...
his control module.
LIU (CONT'D)
No one followsCooper rips the module out. The robot freezes.
...
After a minute, the screen fills with a picture of an icecovered planet. Then nothing. The rest of the probe's drive
...
The entire landscape is contained within a huge cylindershaped space station.
...
Cooper steps closer to the bed. The man's skin is paperthin. He is ancient.
DOCTOR
...
A maintenance worker finishes looking over one of the sleeklooking spacecraft. He packs up his tools and heads out.
